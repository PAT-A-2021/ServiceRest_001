...
namespace ServiceRest_001_AdeliaPingkanAzzahra
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-5MKVHCB;Initial Catalog=TI UMY;Persist Security Info=True;User ID=sa; Password=P1ngka22");
        ...
        {
            {
                ...
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-5MKVHCB;Initial Catalog=TI UMY;Persist Security Info=True;User ID=sa; Password=P1ngka22");
